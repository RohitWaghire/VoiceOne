...
//   })
//
// ESM with no chrome.* at import time — content scripts load it via
// import(chrome.runtime.getURL(...)), so it must stay in web_accessible_resources.

import { findCueIndex } from "./captions.js";
import { bcp47For, labelFor, mergeLanguages } from "./languages.js";

const TOAST_ID = "voiceone-yt-toast";
const PANEL_ID = "voiceone-yt-panel";
const MS_PER_CHAR = 62; // ≈16 chars/sec at TTS rate 1.0

export function createDubEngine(adapter) {
  const state = {
